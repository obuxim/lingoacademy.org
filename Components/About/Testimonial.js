const AboutUsTestimonial = () => {
    return (
        <>
         <div className="rs-testimonial style3 orange-color pt-90 md-pt-70">
        <div className="container">
          <div className="sec-title mb-60 md-mb-30 text-center">
            <div className="sub-title orange">Student Reviews</div>
            <h2 className="title mb-0">What Our Students Says</h2>
          </div>
